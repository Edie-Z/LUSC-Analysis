...
# Load JSON metadata
json_data <- jsonlite::fromJSON("TCGA_Dataset/expression/metadata.cart.2024-11-08.json")
View(json_data)
...
# List count files
count_files <- list.files('TCGA_Dataset/expression/gdc_download_20241108_123324.776410/', pattern = '*.tsv', recursive = TRUE)
count_files[1:10]
...
for (i in seq_along(count_files)) {
  path <- file.path("TCGA_Dataset/expression/gdc_download_20241108_123324.776410", count_files[i])
...
initial_data <- read.delim(file.path("TCGA_Dataset/expression/gdc_download_20241108_123324.776410", count_files[1]), fill = TRUE, header = FALSE, row.names = 1)
